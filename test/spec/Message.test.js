...
define(function(require){
	...
	describe('Message', function() {
		...
		_message = Message.create(_dna, 0, 4);
		beforeEach(function(){
	    ...
	    describe('Message basics', function() {
	    	it('has property queueMe, queueTotal', function() {
		 		...
		 		expect(_message).to.have.property('id');
		    ...
		    it('queueMe===0', function() {
		 		...
		 		expect(_message.id).to.equal('Message');
		    });
		});
		...
		describe('Message children', function() {
		    ...
		    it('first element is a Word', function() {
	    		expect(_message.list[0].id).to.equal('Word');
		    });
